...
import { frequentlyAskedQuestions } from '../types/interface'
...
const FAQ = () => {
  ...
  function revealFirstAnswers(firstIndex: number): void {
  ...
  function revealSecondAnswers(secondIndex: number): void {
